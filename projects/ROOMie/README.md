...
This project is optimized for the **CodeRabbit** track:
- **Custom AI Persona**: Configured as a "Senior Full-Stack Architect" to provide high-level design feedback.
- **Hackathon Mode**: Tuned for speed and security, prioritizing critical bugs over minor style nitpicks.
- **Automated Reviews**: Every PR is automatically analyzed for security vulnerabilities and performance bottlenecks.
- **Configuration**: See `.coderabbit.yaml` for our custom prompt engineering.
